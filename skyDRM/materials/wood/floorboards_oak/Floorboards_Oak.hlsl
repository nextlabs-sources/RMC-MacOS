// $Id: Floorboards_Oak.hlsl,v 1.2 2010-10-28 01:46:51 will Exp $
//version 19
...
void floorboard_color(const HGlobals globals, inout HColor color)
{
	...
	color.specular.a = 0.8 * floorboard_diffuse.a;
}
...
void floorboard_light(const HGlobals globals, const HSurface surface, inout HLighting lighting)
{
	...
	lighting.diffuse *= (0.25 + 0.75 * floorboard_normal.a);
	lighting.specular *= (0.75 + 0.25 * floorboard_normal.a);
}
