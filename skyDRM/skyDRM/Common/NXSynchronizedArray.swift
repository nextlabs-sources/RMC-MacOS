...
//  skyDRM
//
//  Created by Paul (Qian) Chen on 8/21/19.
//  Copyright © 2019 nextlabs. All rights reserved.
//

/// A thread-safe array.
public class NXSynchronizedArray<Element> {
    fileprivate let queue = DispatchQueue(label: "com.nxrmc.skyDRM.NXSynchronizedArray", attributes: .concurrent)
...
// MARK: - Properties
public extension NXSynchronizedArray {
...
public extension NXSynchronizedArray {
    ...
    func enumerated() -> EnumeratedSequence<[Element]> {
        ...
        queue.sync { result = self.array.enumerated() }
        return result!
    }
}
...
// MARK: - Equatable
public extension NXSynchronizedArray where Element: Equatable {
...
public extension NXSynchronizedArray {
    ...
    static func +=(left: inout NXSynchronizedArray, right: Element) {
        left.append(right)
    }
